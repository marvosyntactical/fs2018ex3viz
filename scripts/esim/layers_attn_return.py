...
"""
Edited to return attention weights to attn_return_model.py exclusively for visualization purposes.
"""
...
class SoftmaxAttention(nn.Module):
    ...
    def forward(self,
        ...
        return attended_premises, attended_hypotheses, prem_hyp_attn, hyp_prem_attn
