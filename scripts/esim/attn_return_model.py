...
"""
Edited to return attention values. Strictly for evaluation purposes in ../scripts/visualize.py .
"""

import torch
import torch.nn as nn

from .layers_attn_return import RNNDropout, Seq2SeqEncoder, SoftmaxAttention
...
class ESIM(nn.Module):
    ...
    def forward(self,
        ...
        attended_premises, attended_hypotheses, prem_hyp_attn, hyp_prem_attn =\
        ...
        return logits, probabilities, prem_hyp_attn, hyp_prem_attn
