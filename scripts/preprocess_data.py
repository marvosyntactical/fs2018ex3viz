...
def invert_worddict(data, num_words=None):
	"""
	Copy of the above build_worddict function but inverse
	"""
	worddict = build_worddict(data, num_words)
	
	return {v: k for k, v in worddict}
